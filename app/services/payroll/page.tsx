...
// Payroll Services - EXACTLY 8
const payrollServices = [
  {
    title: 'Full Payroll Processing',
    description: 'Complete PAYE payroll service including employee payments, RTI submissions to HMRC and all compliance obligations',
    icon: (
  ...
  {
    title: 'Employee Payslip App',
    description: 'Secure employee app for 24/7 access to payslips, payroll history, instant notifications and document storage',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Automated payment instruction files compatible with online banking systems for fast, accurate employee payments',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'CIS Returns',
    description: 'Complete CIS compliance support including monthly returns, subcontractor verification, deductions and statements',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'P11D Reporting',
    description: 'Preparation and submission of all P11D forms and P11D(b) declarations for company cars, benefits and perks',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Complete workplace pension compliance including deductions, employee communications and pension provider submissions',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Payroll Setup',
    description: 'Complete payroll setup for new employers including PAYE registration, software configuration and employee onboarding',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Management of all annual obligations including final RTI submissions, employee P60s and year-end reconciliations',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
