...
const benefits = [
  ...
  },
  {
    ...
    icon: (
      // eslint-disable-next-line @next/next/no-img-element
      <img src="https://imagedelivery.net/W93NbEGaswuledAsk5GMeA/a48ad60d-8d95-4a0a-a4cd-8d24f7280a00/public" alt="Immediate Compliance" className="w-20 h-20 md:w-24 md:h-24" />
    ),
  },
  {
    title: 'Growth-Ready',
  ...
  return (
    <>
      ...
      <CTASimple
        ...
        supportingText="Expert company formation with strategic foresight"
      ...
      <CTASimple
        heading="Ready to start your business the right way?"
        supportingText="Complete company formation with expert guidance"
