...
// Our Business Advisory Services - EXACTLY 8 for design consistency
const advisoryServices = [
  ...
  },
  {
    ...
    description: 'Specialist guidance for new ventures, including choosing the right business structure, setting up accounting systems and planning for early-stage growth',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Detailed analysis of your operations, financial KPIs and cost base to identify opportunities for increased efficiency and profitability',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Guidance on the most tax-efficient and operationally effective structure for your business, whether sole trader, partnership or limited company',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
