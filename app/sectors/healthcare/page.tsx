          ...
          <div className="relative bg-gradient-to-br from-[#01458f] to-[#0052cc] rounded-3xl overflow-hidden px-8 md:px-16 py-20 md:py-28">
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
                Expert accounting for<br />healthcare professionals
              </h2>
              ...
              <p className="text-white/90 text-sm md:text-base">
                Tailored financial support for medical, dental, optical and pharmacy professionals
              </p>
      ...
      <section className="w-full flex items-center justify-center bg-white px-4 py-24">
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative bg-gradient-to-br from-[#01458f] to-[#0052cc] rounded-3xl overflow-hidden px-8 md:px-16 py-20 md:py-28">
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">
                Ready to work with<br />specialist healthcare accountants?
              </h2>
              ...
              <p className="text-white/90 text-sm md:text-base">
                Three decades of dedicated healthcare sector experience
              </p>
            </div>
          </div>
        </div>
