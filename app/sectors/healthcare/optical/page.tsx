...
const benefits = [
  {
    ...
    icon: (
      ...
      <img src="https://imagedelivery.net/W93NbEGaswuledAsk5GMeA/5704b5ca-3a45-41f8-52ae-427eadcc4200/public" alt="30+ Years Optical Expertise" className="w-20 h-20 md:w-24 md:h-24" />
    ),
  },
  {
