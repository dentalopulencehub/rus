...
export function SectorsDropdown() {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="dropdown-menu absolute top-full -left-[108px] mt-4 w-[620px] rounded-xl shadow-xl border border-gray-200/50 bg-white/95 backdrop-blur-lg overflow-hidden z-50">
